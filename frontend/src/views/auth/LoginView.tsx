...
export default function LoginView() {
  ...
  return (
    <>
      ...
      <p className="text-2xl font-light text-white mt-5">Llena el formulario para<span className=" text-fuchsia-500 font-bold"> iniciar sesión</span></p>
      ...
      <form className="space-y-8 p-10 mt-10 bg-white" onSubmit={handleSubmit(handleLogin)} noValidate >
        ...
        <input className="bg-fuchsia-600 hover:bg-fuchsia-700 w-full p-3  text-white font-black  text-xl cursor-pointer" type="submit" value='Iniciar Sesión' />
      </form>

      <nav className="mt-10 flex flex-col space-y-4">
          <Link className="text-center text-gray-300 font-normal" to={`/auth/register`}>
            ¿No tienes cuneta? Crear Una
          </Link>
