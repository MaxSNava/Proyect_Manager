...
export default function ConfirmAccountView() {
  ...
  return (
    <>
      ...
      <p className="text-2xl font-light text-white mt-5">Ingresa el código que recibiste <span className=" text-fuchsia-500 font-bold"> por e-mail</span></p>
      ...
      <nav className="mt-10 flex flex-col space-y-4">
        <Link className="text-center text-gray-300 font-normal" to='/auth/request-code'>Solicitar un nuevo Código</Link>
      </nav>
    </>
  )
}