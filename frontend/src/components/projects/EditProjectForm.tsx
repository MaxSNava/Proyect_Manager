    ...
    <>
      <div className="max-w-3xl mx-auto">
        ...
        <form className="mt-10 bg-white shadow-lg p-10 rounded-lg" onSubmit={handleSubmit(handleForm)} noValidate>
          ...
          <input className="bg-fuchsia-600 hover:bg-fuchsia-700 w-full p-3 text-white uppercase font-bold cursor-pointer transition-colors" type="submit" value="Guardar Proyecto" />
        </form>
      </div>
    </>
  )
